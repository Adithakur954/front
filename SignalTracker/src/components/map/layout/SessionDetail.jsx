...
const calculateAverage = (logs, key) => {
  // Convert string values to numbers before filtering
  ...
  const metricSummary = useMemo(() => {
    ...
    sessionData.logs.forEach((log) => {
      const { field } = {
        ...
        rsrq: { field: 'rsrq' },
        sinr: { field: 'sinr' },
        'dl-throughput': { field: 'dl_tpt' },
        'ul-throughput': { field: 'ul_tpt' },
        mos: { field: 'mos' },
        'lte-bler': { field: 'bler' }
      }[selectedMetric.toLowerCase()] || { field: selectedMetric };
        ...
        <div className="flex-grow overflow-y-auto p-4 space-y-4">
          {isLoading ? (
            ...
            <>
              ...
              {/* --- ✅ UPDATED AGGREGATED STATS SECTION --- */}
              <div>
